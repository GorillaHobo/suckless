...
static const char *fonts[] = {"scientifica:size=10", "Font Awesome:size=9", "monospace:size=9"};
...
static Key keys[] = {
    ...
    {MODKEY | ControlMask, XK_n, focusmon, {.i = -1}},
    {MODKEY | ControlMask, XK_o, focusmon, {.i = +1}},
